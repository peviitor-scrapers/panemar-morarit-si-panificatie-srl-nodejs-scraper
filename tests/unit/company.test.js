...
const PANEMAR_ANAF_RECORD = {
  ...
  address: 'JUD. CLUJ, MUN. CLUJ-NAPOCA, STR. TÂRNAVELOR, NR.28',
  caenCode: '1071',
  inactive: false,
  vatRegistered: true,
...
describe('company.js', () => {
  ...
  describe('getCompanyData (no cache)', () => {
    it('should fetch Panemar via direct CIF lookup and return company data', async () => {
  ...
  describe('validateAndGetCompany', () => {
    ...
    // Panemar e activă — testul inactive se rulează doar dacă firma e inactivă
    if (PANEMAR_ANAF_RECORD.inactive) {
