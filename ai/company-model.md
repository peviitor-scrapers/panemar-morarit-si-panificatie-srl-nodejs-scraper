...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Panemar") |
| group        | string   | Parent company group (e.g. "Panemar Systems") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/panemar-morarit-si-panificatie-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)