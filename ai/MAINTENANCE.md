...
```bash
gh issue list --repo peviitor-scrapers/panemar-morarit-si-panificatie-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "Panemar", not the old template
