...
4. Verifică prin API că job-urile companiei apar:
   ```bash
   curl -s "https://api.peviitor.ro/v1/scraper/jobs/?cif=4844886&rows=10" | jq
   ```
5. Verifică că `docs/jobs.md` a fost generat și este accesibil:
   - https://peviitor-scrapers.github.io/panemar-morarit-si-panificatie-srl-nodejs-scraper/jobs.md
