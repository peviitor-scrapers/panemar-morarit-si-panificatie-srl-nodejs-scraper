...
```bash
gh run view <RUN_ID> --repo sebiboga/panemar-morarit-si-panificatie-srl-nodejs-scraper --json status -q .status
```
...
**On every session:**
1. Check open GitHub issues: `gh issue list --repo sebiboga/panemar-morarit-si-panificatie-srl-nodejs-scraper --state open`
